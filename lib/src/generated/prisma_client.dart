...
enum UserScalarFieldEnum { id, name, email, password }
...
class UserWhereInput implements _i2.JsonSerializable {
  ...
  final _i2.PrismaNullable<_i2.PrismaUnion<StringFilter, String>> email;

  final _i2.PrismaNullable<_i2.PrismaUnion<StringFilter, String>> password;
...
class UserUpdateInput implements _i2.JsonSerializable {
  ...
  final _i2.PrismaNullable<
      _i2.PrismaUnion<String, StringFieldUpdateOperationsInput>> email;

  final _i2.PrismaNullable<
      _i2.PrismaUnion<String, StringFieldUpdateOperationsInput>> password;
...
class UserDelegate {
  ...
  Future<User> upsert({
    required UserWhereUniqueInput where,
    required _i2.PrismaUnion<UserCreateInput, UserUncheckedCreateInput> create,
    required _i2.PrismaUnion<UserUpdateInput, UserUncheckedUpdateInput> update,
  }) async {
    final String sdl = _i2.GraphQLField(
      'mutation',
      fields: _i2.GraphQLFields([
...
const String _executable =
    r'C:\Users\fernn\Documents\GitHub\learning_dart\.dart_tool\prisma\query-engine';
